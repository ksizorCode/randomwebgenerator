...
$dato =[
    ...
    Con el paso de los siglos, el deporte evolucionó. En la Edad Media, los torneos de caballeros deslumbraban a las cortes reales, donde la destreza en la equitación y el manejo de la espada eran admirados por todos. Y así, de generación en generación, el espíritu competitivo se mantuvo vivo.
    
    En tiempos modernos, el deporte se convirtió en una pasión mundial. Las olimpiadas modernas se establecieron para reunir a atletas de todas las naciones, mostrando que la competencia puede unir en lugar de dividir. Desde el fútbol hasta el baloncesto, desde el tenis hasta el atletismo, el deporte ha cruzado fronteras y ha inspirado a millones de personas a superar sus límites.
    ...
    Pero el deporte no es solo para los profesionales. Cada vez más personas se unen a equipos locales, juegan partidos amistosos o simplemente salen a correr por el vecindario. ¡Incluso los videojuegos han dado paso a los deportes electrónicos, donde los jugadores compiten a nivel mundial desde la comodidad de sus sofás!
    ...
    'img2'=>'themes/ric/img/001.jpg',
    'img3'=>'themes/ric/img/001.jpg',
    'menu'=>[
            ['Inicio','index.php',0],
